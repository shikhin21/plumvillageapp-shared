...
export const loadStripePaymentRecord = (id, chargeData, Timestamp) => {
    ...
    return ({
        ...
        email: chargeData.billing_details.email || ((_a = chargeData.invoice) === null || _a === void 0 ? void 0 : _a.customer_email) || chargeData.receipt_email || '',
        customerName: chargeData.billing_details.name || ((_b = chargeData.invoice) === null || _b === void 0 ? void 0 : _b.customer_name) || '',
